...
before touching DNS — it isolates "is the site fine" from "is the domain fine".
...
The site says `hello@snehajain.co.uk`, which does not exist yet — GitHub Pages
hosts web pages only, never email. Options, cheapest first:
...
- **Google Workspace / Microsoft 365** — about £5–6 a month, full mailbox, sends
